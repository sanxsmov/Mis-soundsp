...
runtime.Track(UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if gameProcessed or knifeMacroBusy or not knifeMacroEnabled then return end
    ...
    if knife and humanoid and knife:IsA("Tool") then
        humanoid:EquipTool(knife)
        task.wait(knifeEquipDelay)

        -- Reproduce el mismo botón L2 (Throw) del juego y lo suelta automáticamente.
        ...
        if ok and vim then
            ...
            -- Fallback para juegos que exponen un objeto Throw.
