...
local function playJumpSound(character)
    if not jumpSoundEnabled or jumpSoundId == "" then return end
...
Tabs.Config:Section({ Title = "Sonido al Saltar" })
...
Tabs.Config:Input({
    ...
    Desc = "Escribe solo el ID de Roblox del audio.",
