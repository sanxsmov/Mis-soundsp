...
-- MACRO CUCHILLO: L2 = un toque para lanzar (no mantener)
local knifeBusy = false
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if gameProcessed or knifeBusy or not knifeMacroEnabled then return end
    if input.KeyCode == Enum.KeyCode.ButtonL2 then
        ...
        if knife and humanoid then
            ...
            -- L2 corresponde a Throw. No usa Tool:Activate(), para no convertirlo en Slash.
...
-- Configuración independiente de la macro de cuchillo
...
UIElements.TogMacro = Tabs.Aim:Toggle({
    Title = "Activar Macro", 
-- Opción independiente de la macro de cuchillo
-- Conecta este callback a tu sistema de toggle de UI si corresponde:
-- knifeMacroEnabled = true/false
